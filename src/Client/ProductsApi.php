...
class ProductsApi
{
     ...
     */
    public function getSaleProduct($product_id, $category_id = null)
    {
        list($response) = $this->getSaleProductWithHttpInfo($product_id, $category_id);
        return $response;
    }
     ...
     */
    public function getSaleProductWithHttpInfo($product_id, $category_id = null)
    {
        $request = $this->getSaleProductRequest($product_id, $category_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSaleProductAsync($product_id, $category_id = null)
    {
        return $this->getSaleProductAsyncWithHttpInfo($product_id, $category_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSaleProductAsyncWithHttpInfo($product_id, $category_id = null)
    {
        $returnType = '\AllegroApi\Model\SaleProductDto';
        $request = $this->getSaleProductRequest($product_id, $category_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSaleProductRequest($product_id, $category_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSaleProductsRequest($ean = null, $phrase = null, $category_id = null, $dynamic_filters = null, $page_id = null)
    {

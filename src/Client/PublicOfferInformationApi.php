...
class PublicOfferInformationApi
{
     ...
     * @param  int $offset Index of the first returned offer from all search results. Max offset is: - &#x60;120000 - &lt;limit&gt;&#x60; if seller.id parameter is given in request,     - &#x60;6000 - &lt;limit&gt;&#x60; if no seller.id parameter is given in request. (optional, default to 0)
    ...
    {
        if ($offset !== null && $offset > 119999) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling PublicOfferInformationApi.getListing, must be smaller than or equal to 119999.');
        }

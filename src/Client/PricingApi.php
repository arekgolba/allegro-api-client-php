...
class PricingApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function previewFeesPublicAPIUsingPOSTRequest($wrapper_type_for_preview_conditions)
    {
        ...
        if (isset($wrapper_type_for_preview_conditions)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($wrapper_type_for_preview_conditions));
            } else {
                $httpBody = $wrapper_type_for_preview_conditions;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

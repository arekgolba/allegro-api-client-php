...
class OfferManagementApi
{
     ...
     *
     * @param  \AllegroApi\Model\SaleProductOfferRequest $sale_product_offer_request sale_product_offer_request (required)
     *
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AllegroApi\Model\SaleProductOfferResponse|\AllegroApi\Model\SaleProductOfferResponse|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\AuthError|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\ErrorsHolder
     */
     ...
     * Create offer based on product
     *
     * @param  \AllegroApi\Model\SaleProductOfferRequest $sale_product_offer_request (required)
     *
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AllegroApi\Model\SaleProductOfferResponse|\AllegroApi\Model\SaleProductOfferResponse|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\AuthError|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductOffersWithHttpInfo($sale_product_offer_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\AllegroApi\Model\SaleProductOfferResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AllegroApi\Model\SaleProductOfferResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 202:
            ...
            $returnType = '\AllegroApi\Model\SaleProductOfferResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AllegroApi\Model\SaleProductOfferResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $offer_id The offer identifier. (required)
     * @param  \AllegroApi\Model\SaleProductOfferPatchRequest $sale_product_offer_patch_request sale_product_offer_patch_request (required)
     *
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AllegroApi\Model\SaleProductOfferResponse|\AllegroApi\Model\SaleProductOfferResponse|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\AuthError|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\ErrorsHolder
     ...
     *
     * @param  string $offer_id The offer identifier. (required)
     * @param  \AllegroApi\Model\SaleProductOfferPatchRequest $sale_product_offer_patch_request (required)
     *
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AllegroApi\Model\SaleProductOfferResponse|\AllegroApi\Model\SaleProductOfferResponse|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\AuthError|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     ...
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AllegroApi\Model\SaleProductOfferResponse
     */
     ...
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AllegroApi\Model\SaleProductOfferResponse, HTTP status code, HTTP response headers (array of strings)
     */

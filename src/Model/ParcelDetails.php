...
class ParcelDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['service_id']) && ($this->container['service_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'service_id', must be bigger than or equal to 1.";
        }
     ...
     * Sets service_id
     *
     * @param int|null $service_id Delivery service id.
     *
     * @return self
     */
    public function setServiceId($service_id)
    {
        ...
        if (!is_null($service_id) && ($service_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $service_id when calling ParcelDetails., must be bigger than or equal to 1.');
        }

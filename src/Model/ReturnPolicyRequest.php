...
class ReturnPolicyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string|null $name Return policy name.
     *
     * @return self
     */
     ...
     * Gets availability
     *
     * @return \AllegroApi\Model\ReturnPolicyAvailability|null
     */
     ...
     * Sets availability
     *
     * @param \AllegroApi\Model\ReturnPolicyAvailability|null $availability availability
     *
     * @return self
     */
     ...
     * Gets return_cost
     *
     * @return \AllegroApi\Model\ReturnPolicyReturnCost|null
     */
     ...
     * Sets return_cost
     *
     * @param \AllegroApi\Model\ReturnPolicyReturnCost|null $return_cost return_cost
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 10240)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ReturnPolicyRequest., must be smaller than or equal to 10240.');
        }

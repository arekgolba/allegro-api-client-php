...
/**
 * SaleProductOfferRequest Class Doc Comment
 *
 * @category Class
 * @package  AllegroApi
 * @author   OpenAPI Generator team
 ...
 */
class SaleProductOfferRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleProductOfferRequest';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SaleProductOfferRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets stock
     *
     * @param \AllegroApi\Model\Stock $stock stock
     *
     * @return self
     */

...
class ParcelCreationParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['service_id'] < 1)) {
     ...
     * Sets service_id
     *
     * @param int $service_id Delivery service id.
     *
     * @return self
     */
    public function setServiceId($service_id)
    {
        ...
        if (($service_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $service_id when calling ParcelCreationParameters., must be bigger than or equal to 1.');
        }
